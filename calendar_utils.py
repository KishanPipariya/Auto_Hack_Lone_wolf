...
def generate_ics(itinerary: Itinerary, start_date_str: str = None) -> bytes:
    """
    ...
    for day in itinerary.days:
        ...
        summary_event.begin = current_day_date
        ...
        current_time = datetime.combine(current_day_date, datetime.strptime("09:00", "%H:%M").time())
        ...
        for activity in day.activities:
            ...
            # Duration logic
            duration_hours = activity.duration_hours if isinstance(activity.duration_hours, (int, float)) else 1.0
            # Cap crazy durations
            if duration_hours > 8: duration_hours = 8
